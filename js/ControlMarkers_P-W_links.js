L.Control.SimpleMarkers = L.Control.extend({
    ...
    onMapClickAddMarker: function(e) {
        ...
        AlphaKP = Math.abs(AlphaW - AlphaZ);
                                           
        //AlphaB = Math.abs(AlphaA - AlphaKP);
        AlphaB = Math.abs(AlphaA + (AlphaW - AlphaZ));
                                           
        //AlphaC = Math.abs(AlphaA + AlphaKP);
        AlphaC = Math.abs(AlphaA - (AlphaW - AlphaZ));
        ...
        if(AlphaC > AlphaB) {
          ...
          BetaP = BetaL + AlphaKP;
          Gamma = 180 - AlphaC - BetaP;               // zur Bestimmung der Kurslinienlänge
        }
        ...
        var KWrichtung = (KW + 180 > 360) ? KW + 180 - 360 : KW + 180;
        //var entLayLineWinkel2 = (LayLineWinkel2 + 180 > 360) ? LayLineWinkel2 + 180 - 360 : LayLineWinkel2 + 180;
        ...
        if (AlphaA < AlphaKP) {
          ...
          KursWinkel = (KP < 180) ? AlphaZ + AlphaB : 360 + AlphaZ - AlphaC;
